...
- [Dockhero](https://dockhero.io/) - Docker-as-a-service Heroku addon which turns any Docker image into a stateful microservice attached to the Heroku app. Currently in Beta.
