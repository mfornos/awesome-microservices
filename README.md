...
- [Shimmy](https://github.com/Michael-A-Kuykendall/shimmy) - AI microservice runtime framework for building OpenAI-compatible inference services with hot model swapping.
