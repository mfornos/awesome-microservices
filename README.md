...
- [Sails.js](https://sailsjs.com) - A Realtime MVC Framework for Node.js
...
- [Microservices and SOA](https://blogs.oracle.com/oraclemagazine/microservices-and-soa) - Similarities, differences, and where we go from here.
